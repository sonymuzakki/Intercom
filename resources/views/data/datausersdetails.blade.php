        ...
        <div class="row">
            <div class="col-8">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama"  class="form-control" id="exampleFormControlInput1" placeholder="" value="{{ $data->nama }}" disabled>
                        </div>
                        <div class="mb-3">
                ...
                <div class="d-md-flex justify-content-md-end mb-2 ">
                    ...
                    <button type="submit" class="btn btn-warning btn-lg mb-2  justify-content-lg-end"</button><i class="fa-solid fa-pen-to-square"></i> Edit</button>
                  </div>
            </div>
